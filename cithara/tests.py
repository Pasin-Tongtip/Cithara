...
class DomainModelTest(TestCase):
    def setUp(self):
        self.google_account_user = GoogleAccount.objects.create(email="test@gmail.com")
        self.google_account_creator = GoogleAccount.objects.create(email="creator@gmail.com")
        self.user = User.objects.create(google_account=self.google_account_user, name="Test User")
        self.creator = SongCreator.objects.create(google_account=self.google_account_creator, name="Creator")
    ...
    def test_create_song_success(self):
        ...
        self.assertEqual(song.library.owner, self.creator)
    ...
    def test_song_must_have_creator(self):
        ...
        self.assertIsNotNone(song.library.owner)
